...
%*************************************************************
function[A,B,EQM]=treinamento(X,S,h)
...
if h == 5
   savefig('matfinal5-trein.fig');
elseif h==10
   savefig('matfinal10-trein.fig');
elseif h==15
   savefig('matfinal15-trein.fig');
elseif h==20
   savefig('matfinal20-trein.fig');
elseif h==30
   savefig('matfinal30-trein.fig');
end
...
if h == 5
   save matfinal5 A B nerro;   
   savefig('matfinal5-epocas.fig');
   %save nerro5 nerro;
elseif h==10
   save matfinal10 A B nerro;      
   %save nerro10 nerro;
   savefig('matfinal10-epocas.fig');
elseif h==15
   save matfinal15 A B nerro;      
   %save nerro15 nerro;
   savefig('matfinal15-epocas.fig');
elseif h==20
   save matfinal20 A B nerro;   
   %save nerro20 nerro;
   savefig('matfinal20-epocas.fig');
elseif h==30
   save matfinal30 A B nerro;   
   savefig('matfinal30-epocas.fig');
end
